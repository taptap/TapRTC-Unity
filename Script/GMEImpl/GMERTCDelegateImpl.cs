...
namespace TapTap.RTC.GMEImpl
{
    public class GMERTCDelegateImpl : ITapRTC
    {
        ...
        public Task<bool> Init(TapRTCConfig config)
        {
        ...
        public bool Init(TapRTCConfig config, ProviderResponse response)
        {
            ...
            if (ret != QAVError.OK)
            {
                ...
                throw new TapRTCException(ret, "GME Init failure!");
            }
        ...
        public bool UnInit()
        {
            ...
            return ITMGContext.GetInstance().Uninit() == QAVError.OK;
        }
        ...
        {
            ITapRTCRoomDelegate roomDelegate = new GMERTCRoomDelegateImpl(config, roomId, rangeAudio);
