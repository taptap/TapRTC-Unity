...
namespace TencentMobileGaming
{
    ...
    public abstract class ITMGContext
	{
        ...
        public static string IENGINE_VERSION = QAVError.GMESDK_VERSION_f841ee0878b857452539a6d09379d1453028e35c;
        static ITMGContext(){         
            QAVSDKInit.InitSDK();
	...
	public abstract class ITMGRoom
	{
        ...
        // position and rotate should be under the world coordinate system specified by IsEnableSpatializer, rightward, upward direction.
